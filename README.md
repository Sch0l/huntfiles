...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hui7ni0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hui7ni0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Sch0l/huntfiles.git
cd container-hui7ni0
```
...
```
docker attach container-hui7ni0
```
